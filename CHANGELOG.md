...
- Python:
  - Drop Python 3.6 support in favour to Python 3.9 and newer
- Project:
  - Replace [Flit](https://pypi.org/project/flit/) package manager with [Poetry](https://python-poetry.org/) package and dependency manager
